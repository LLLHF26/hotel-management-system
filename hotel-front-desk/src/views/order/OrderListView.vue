          ...
          <template #default="{ row }">
            <div class="action-group">
              ...
              <template v-if="row.status === '待支付'">
                ...
                <el-button link type="danger" @click="actionRef?.openCancel(row)">取消</el-button>
              </template>
...
function filterTodayCheckIn() {
  query.checkInDate = todayStr()
  dateRange.value = null
  query.status = ''
  search()
}

function filterTodayCheckOut() {
  query.checkInDate = ''
