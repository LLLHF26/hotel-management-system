  ...
  try {
    ...
    return {
      ...
      data: {
        ...
        size: params.size ?? 10,
        records: [
          { id: 1, name: '豪华大床房', description: '45㎡，独立卫浴，城市景观', area: 45, bedType: '1 大床', maxGuests: 2, price: 588.0, coverImage: '', amenities: 'WiFi, 电视, 迷你吧', sortOrder: 1 },
          { id: 2, name: '商务双床房', description: '42㎡，双床，办公空间', area: 42, bedType: '2 单床', maxGuests: 2, price: 488.0, coverImage: '', amenities: 'WiFi, 书桌, 浴缸', sortOrder: 2 },
          { id: 3, name: '行政套房', description: '65㎡，独立客厅，豪华配置', area: 65, bedType: '1 大床', maxGuests: 3, price: 998.0, coverImage: '', amenities: 'WiFi, 沙发, 独立客厅', sortOrder: 3 }
        ]
      }
    }
  }
